...
//             <div className='flex gap-x-5 items-center w-full m-10 '>
...
//                     <br/>
//                     <p className='text-sm text-richblack-300'>As experienced educators ourselves, we witnessed firsthand the limitations and challenges of traditional education systems. We believed that education should not be confined to the walls of a classroom or restricted by geographical boundaries. We envisioned a platform that could bridge these gaps and empower individuals from all walks of life to unlock their full potential.</p>
//                 </div>
//                 <div className='w-[50%] ml-1 '>
//                     <img src={FoundingStory} className='h-[180px] ml-10'/>
//                 </div>
//             </div>
...
//     {/* section 5 */}
//     <section className=' mx-auto   flex flex-col items-center justify-between gap-5 mb-[140]'>
//          <LearningGrid/>
//          <ContactFormSection/>
//     </section>
//     <section>
